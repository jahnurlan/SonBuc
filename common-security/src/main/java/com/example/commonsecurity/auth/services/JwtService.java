...
public class JwtService {
    ...
    public String generateGuestAccessToken(UserDetails guestUserDetails) {
        long oneDayInMillis = 1000L * 60 * 60 * 24; // 1 gün = 86400000 ms

        Map<String, Object> extractClaims = new HashMap<>();
        extractClaims.put("roles", extractRoles(guestUserDetails));

        return generateToken(extractClaims, guestUserDetails, oneDayInMillis);
    }
