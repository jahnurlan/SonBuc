package com.example.timerms.config;
...
public class SecurityConfig implements ApplicationSecurityConfigurer {
    ...
    private static final String POST_GET_TIMER = "/timer/**";
    private static final String POST_GET_TIME_NOTE = "/time-note/**";
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .antMatchers(POST_GET_TIMER).hasAnyRole(RoleType.USER.name(), RoleType.GUEST.name())
                                .antMatchers(POST_GET_TIME_NOTE).hasAnyRole(RoleType.USER.name(), RoleType.GUEST.name())
                )
